//----------------Header------------
document.getElementById("About").onclick = function() { ninja.tabSwitch(this);};
document.getElementById("Readme").onclick = function() { ninja.tabSwitch(this);};
document.getElementById("ChangeLog").onclick = function() { ninja.tabSwitch(this);};
document.getElementById("SyncTests").onclick = function() { ninja.tabSwitch(this);};
...
function postText(text){
  ...
  document.getElementById("aboutTextArea").innerHTML += text;
  document.getElementById("aboutTextArea").lastChild.setFocus;
}
	...
	ninja.wallets.About = {
		open: function () {
			...
			$.get("./docs/About.md", function(data, status){
        var converter = new showdown.Converter();
        document.getElementById("aboutTextArea").innerHTML = converter.makeHtml(data);
      });
 ...
 ***************************************************/
	...
	ninja.wallets.ChangeLog = {
		open: function () {
			//document.getElementById("backarea").style.display = "block";
						$.get("./docs/ChangeLog.md", function(data, status){
        var converter = new showdown.Converter();
        document.getElementById("aboutTextArea").innerHTML = converter.makeHtml(data);
      });
		},
...
(function (ninja) {
    ...
    document.getElementById("aboutTextArea").innerHTML="Synchronous Test Results"; 
			...
			for (var test in ut.synchronousTests) {
				...
				testCount++;
				//document.getElementById("aboutTextArea").innerHTML += test + ": " + passFailStr + "<br>";
				await postText(test + ": " + passFailStr + "<br>");
        ...
        //document.getElementById('readMeTextArea').style.display = 'block';
			...
			//document.getElementById("aboutTextArea").innerHTML += passCount + " of " + testCount + " synchronous tests passed";
			postText(passCount + " of " + testCount + " synchronous tests passed");
			if (passCount < testCount) {
				//document.getElementById("aboutTextArea").innerHTML += "<b>" + (testCount - passCount) + " unit test(s) failed</b>";
				postText("<b>" + (testCount - passCount) + " unit test(s) failed</b>");
			}
